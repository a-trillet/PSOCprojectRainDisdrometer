 ...
 */
#define CY_BLE_DEV_INT_SERVICE_INDEX   (0x00u) /* Index of dev_int service in the cy_ble_customs array */
#define CY_BLE_DEV_INT_RED_LED_ON_CHAR_INDEX   (0x00u) /* Index of RED_LED_ON characteristic */
#define CY_BLE_DEV_INT_RED_LED_ON_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_DEV_INT_RED_LED_TOGGLE_CHAR_INDEX   (0x01u) /* Index of RED_LED_TOGGLE characteristic */
#define CY_BLE_DEV_INT_COUNTER_CHAR_INDEX   (0x02u) /* Index of counter characteristic */
#define CY_BLE_DEV_INT_COUNTER_COUNTERCCCD_DESC_INDEX   (0x00u) /* Index of countercccd descriptor */
#define CY_BLE_DEV_INT_COUNTER_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_DEV_INT_SERVICE_HANDLE   (0x0010u) /* Handle of dev_int service */
#define CY_BLE_DEV_INT_RED_LED_ON_DECL_HANDLE   (0x0011u) /* Handle of RED_LED_ON characteristic declaration */
#define CY_BLE_DEV_INT_RED_LED_ON_CHAR_HANDLE   (0x0012u) /* Handle of RED_LED_ON characteristic */
#define CY_BLE_DEV_INT_RED_LED_ON_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_DEV_INT_RED_LED_TOGGLE_DECL_HANDLE   (0x0014u) /* Handle of RED_LED_TOGGLE characteristic declaration */
#define CY_BLE_DEV_INT_RED_LED_TOGGLE_CHAR_HANDLE   (0x0015u) /* Handle of RED_LED_TOGGLE characteristic */
#define CY_BLE_DEV_INT_COUNTER_DECL_HANDLE   (0x0016u) /* Handle of counter characteristic declaration */
#define CY_BLE_DEV_INT_COUNTER_CHAR_HANDLE   (0x0017u) /* Handle of counter characteristic */
#define CY_BLE_DEV_INT_COUNTER_COUNTERCCCD_DESC_HANDLE   (0x0018u) /* Handle of countercccd descriptor */
#define CY_BLE_DEV_INT_COUNTER_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0019u) /* Handle of Characteristic User Description descriptor */
