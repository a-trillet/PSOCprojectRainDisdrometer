...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* dev_int service */
    {
        0x0010u, /* Handle of the dev_int service */ 
        {

            /* RED_LED_ON characteristic */
            {
                0x0012u, /* Handle of the RED_LED_ON characteristic */ 
            ...
            /* RED_LED_TOGGLE characteristic */
            {
                0x0015u, /* Handle of the RED_LED_TOGGLE characteristic */ 
            ...
            {
                0x0017u, /* Handle of the counter characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0018u, /* Handle of the countercccd descriptor */ 
