...
module SCB_UART_PDL_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("b23f92bd-7bcf-43ed-9bfc-b57238cb8e04/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("b23f92bd-7bcf-43ed-9bfc-b57238cb8e04/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("b23f92bd-7bcf-43ed-9bfc-b57238cb8e04/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module Scan_ADC_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("a71e7168-ed7a-414c-8b11-1760d1cc9ab1/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=1, Period=103, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer, CY_INSTANCE_SHORT_NAME=Timer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer, )
...
// MCWDT_PDL_v1_10(C0_enable=true, C0ClearOnMatch=0, C0Match=32768, C0Mode=0, C1_enable=true, C1ClearOnMatch=1, C1Match=20, C1Mode=1, C2_enable=false, C2Mode=0, C2Period=5, CascadeC0C1=true, CascadeC1C2=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=MCWDT_PDL_v1_10, CY_CONFIG_TITLE=MCWDT_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=MCWDT_1, CY_INSTANCE_SHORT_NAME=MCWDT_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=mcwdt, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=MCWDT_1, )
module MCWDT_PDL_v1_10_5 (
    interrupt);
    output      interrupt;
...
// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=0, OpampRange=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=Opamp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Opamp, )
module OpAmp_PDL_v1_0_6 (
    Vminus,
    Vout,
    Vplus);
    inout       Vminus;
...
// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=0, OpampRange=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=Opamp2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp2, CY_INSTANCE_SHORT_NAME=Opamp2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Opamp2, )
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("206f4099-2ed0-4d88-b20d-069a71bf9679"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("4cb51a94-2dfb-495d-a491-48a6a464fe27"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
    ...
    TCPWM_Counter_PDL_v1_0_4 Timer (
        .capture(1'b0),
        .clock(Net_363),
        .compare(Net_359),
        .count(1'b1),
	...
	wire [0:0] tmpFB_0__vplus1_net;
	wire [0:0] tmpIO_0__vplus1_net;
	electrical [0:0] tmpSIOVREF__vplus1_net;

	cy_mxs40_gpio_v1_0
		#(.id("282aaed2-d463-4c6d-af85-be33f1e98849"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		vplus1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__vplus1_net[0:0]}),
		  .analog({Net_440}),
		  .io({tmpIO_0__vplus1_net[0:0]}),
		  .siovref(tmpSIOVREF__vplus1_net));
    ...
    MCWDT_PDL_v1_10_5 MCWDT_1 (
        .interrupt(Net_418));

    OpAmp_PDL_v1_0_6 Opamp (
        .Vminus(Net_480),
        .Vout(Net_488),
        .Vplus(Net_440));
	...
	wire [0:0] tmpFB_0__vmin1_net;
	wire [0:0] tmpIO_0__vmin1_net;
	electrical [0:0] tmpSIOVREF__vmin1_net;
	...
	cy_mxs40_gpio_v1_0
		...
		vmin1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__vmin1_net[0:0]}),
		  .analog({Net_480}),
		  .io({tmpIO_0__vmin1_net[0:0]}),
		  .siovref(tmpSIOVREF__vmin1_net));


	wire [0:0] tmpFB_0__vout1_net;
	wire [0:0] tmpIO_0__vout1_net;
	electrical [0:0] tmpSIOVREF__vout1_net;

	cy_mxs40_gpio_v1_0
		#(.id("f6da831e-6764-40cf-8b6e-8e0ec1d9b507"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		vout1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__vout1_net[0:0]}),
		  .analog({Net_488}),
		  .io({tmpIO_0__vout1_net[0:0]}),
		  .siovref(tmpSIOVREF__vout1_net));


    OpAmp_PDL_v1_0_7 Opamp2 (
        .Vminus(Net_506),
        .Vout(Net_527),
        .Vplus(Net_488));
	...
	wire [0:0] tmpFB_0__vmin2_net;
	wire [0:0] tmpIO_0__vmin2_net;
	electrical [0:0] tmpSIOVREF__vmin2_net;

	cy_mxs40_gpio_v1_0
		#(.id("7b079656-572b-4288-a7ef-ff25e4e51a4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		vmin2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__vmin2_net[0:0]}),
		  .analog({Net_506}),
		  .io({tmpIO_0__vmin2_net[0:0]}),
		  .siovref(tmpSIOVREF__vmin2_net));


	wire [0:0] tmpFB_0__vout2_net;
	wire [0:0] tmpIO_0__vout2_net;
	electrical [0:0] tmpSIOVREF__vout2_net;

	cy_mxs40_gpio_v1_0
		#(.id("e7804662-14be-44d4-a61f-d94a8363d9f3"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		vout2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__vout2_net[0:0]}),
		  .analog({Net_527}),
		  .io({tmpIO_0__vout2_net[0:0]}),
		  .siovref(tmpSIOVREF__vout2_net));
